...
/* 字体相关属性 */
.parent {
  font-family: "Times New Roman", serif; /* 可继承 */
  font-size: 16px; /* 可继承 */
  font-style: italic; /* 可继承 */
  font-weight: bold; /* 可继承 */
  font-variant: small-caps; /* 可继承 */
  font: 14px/1.5 Arial, sans-serif; /* 可继承 */
}
...
.parent {
  ...
  text-indent: 2em; /* 可继承 */
  text-transform: uppercase; /* 可继承 */
  letter-spacing: 1px; /* 可继承 */
  word-spacing: 2px; /* 可继承 */
  white-space: nowrap; /* 可继承 */
}

/* 列表相关属性 */
.parent {
  list-style-type: disc; /* 可继承 */
  list-style-position: inside; /* 可继承 */
  list-style-image: url("bullet.png"); /* 可继承 */
  list-style: square inside; /* 可继承 */
}

/* 其他可继承属性 */
.parent {
  visibility: hidden; /* 可继承 */
  cursor: pointer; /* 可继承 */
  quotes: '"' '"' "'" "'"; /* 可继承 */
  direction: rtl; /* 可继承 */
}
...
<html>
  <head>
    <style>
      .parent {
        font-size: 2em; /* 相对于浏览器默认字体大小 16px * 2 = 32px */
        color: red;
      }

      .child {
        font-size: 1.5em; /* 相对于继承的 32px * 1.5 = 48px */
      }
    </style>
  </head>
  <body>
    <div class="parent">
      父元素 (32px)
      <div class="child">子元素 (48px，不是 1.5 * 16px = 24px)</div>
    </div>
  </body>
</html>
```
